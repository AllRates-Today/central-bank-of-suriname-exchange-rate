'use strict';
// Central Bank of Suriname exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbvs';
...
/** Latest rate for one pair, e.g. getRate('USD', 'SRD', { apiKey }). */
